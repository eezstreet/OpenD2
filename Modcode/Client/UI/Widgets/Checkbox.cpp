...
namespace D2Widgets
{
	 ...
	 *	@author	eezstreet
	 */
	Checkbox::Checkbox(int _x, int _y, bool bStartChecked) : D2Widget()
	{
		x = _x;
		y = _y;
		w = 15;
	 ...
	 *	@author	eezstreet
	 */
	void Checkbox::AttachLabel(char16_t* szText)
	{
	 ...
	 *	@author	eezstreet
	 */
	bool Checkbox::HandleMouseDown(DWORD dwX, DWORD dwY)
	{
	 ...
	 *	@author eezstreet
	 */
	bool Checkbox::HandleMouseClick(DWORD dwX, DWORD dwY)
	{
		if (dwX >= x && dwX <= x + w && dwY >= y && dwY <= y + h)
		{
